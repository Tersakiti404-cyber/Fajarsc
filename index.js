...
const kapanbotaktif = 'SESUAI MOOD/KEINGINAN OWNER'; 
const whatsapp = 'wa.me/6281333782061';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot Dibuat Oleh FajarGans ig:mr.tersakiti_404')
